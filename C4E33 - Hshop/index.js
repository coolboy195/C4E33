...
function renderHtml(data, rootItems) {
  ...
  <div id='box1' class='col'><div><h4>${data.name}</h4><h5><a style='color: red'>Price: ${data.price}</a></h5><h4><a id='${data.productId}' onClick='buynow(this.id,"${rootItems}")'>BUY NOW</a></h4></div></div></div>`
